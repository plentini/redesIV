...
${OBJECTDIR}/iAlmacenero.o: iAlmacenero.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/iAlmacenero.o iAlmacenero.cpp

${OBJECTDIR}/iEncargado.o: iEncargado.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/iEncargado.o iEncargado.cpp

${OBJECTDIR}/lanzador.o: lanzador.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/lanzador.o lanzador.cpp
